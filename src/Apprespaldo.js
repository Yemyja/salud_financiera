...
//   // Usa toFixed(0) para obtener el porcentaje sin decimales
...
//       emergencias: 10,
//       gastos_miscelaneos: 10,
//       // Agrega más categorías con sus porcentajes máximos
//     };
...
//     <input
//       type="number"
//       value={getMaxExpensePercentageByCategory('alimentacion')}
//       onChange={(e) => updateMaxExpensePercentage('alimentacion', e.target.value)}
//     />
//               ):(calculateTotalExpensePercentageByCategory('alimentacion') + '%')}
//   </td>
//   <td>
//                 {showExpenseTable ? (
//                   <button
...
// import useMaxExpensePercentage from './useMaxExpensePercentage'; // Asegúrate de ajustar la ruta según la ubicación de tu archivo useMaxExpensePercentage.js
...
// useEffect(() => {
//   saveDataToLocalStorage('incomes', incomes);
// }, [incomes]);

// useEffect(() => {
//   saveDataToLocalStorage('maxExpensePercentage', maxExpensePercentage);
// }, [maxExpensePercentage]);

//  // Load expenses and incomes from local storage when the component mounts
//  useEffect(() => {
...
//   const storedIncomes = getDataFromLocalStorage('incomes');
//   if (storedIncomes) {
//     setIncomes(storedIncomes);
//   }
// }, []);

// Load maxExpensePercentage from local storage when the component mounts
// useEffect(() => {
//   const storedMaxExpensePercentage = getDataFromLocalStorage('maxExpensePercentage');
//   if (storedMaxExpensePercentage) {
//     setMaxExpensePercentage(storedMaxExpensePercentage);
//   }
// }, []);
// useEffect(() => {
//   const storedMaxExpensePercentage = getDataFromLocalStorage('maxExpensePercentage');
